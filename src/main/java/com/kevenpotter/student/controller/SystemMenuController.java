...
public class SystemMenuController {
    ...
    public ApiResult getMenus(
        ...
        PageInfo<SystemMenuEntity> pageInfo = new PageInfo<SystemMenuEntity>(systemMenuService.getMenus(menuName, menuStatus));
    ...
    @ResponseBody
    @PostMapping("/menus")
    public ApiResult addMenu(@RequestBody SystemMenuDto systemMenuDto) {
        if (null == systemMenuDto) return ApiResult.buildFailure(ApiConstant.CODE_1, "请求参数为空");
        SystemMenuEntity systemMenuEntity = systemMenuService.addSystemMenu(systemMenuDto);
    ...
    @ResponseBody
    @PutMapping("/menus")
    public ApiResult updateMenu(@RequestBody SystemMenuDto systemMenuDto) {
        if (null == systemMenuDto) return ApiResult.buildFailure(ApiConstant.CODE_1, "请求参数为空");
        SystemMenuEntity systemMenuEntity = systemMenuService.updateSystemMenu(systemMenuDto);
    ...
    public ApiResult getSystemMenuByMenuName(@PathVariable String menuName) throws UnsupportedEncodingException {
        ...
        SystemMenuEntity systemMenuEntity = systemMenuService.getMenuByMenuName(menuName);
    ...
    @ResponseBody
    @PostMapping("/menuLi")
    public ApiResult getSystemMenuByMenuLinkUrl(@RequestParam("menuLinkUrl") String menuLinkUrl) throws UnsupportedEncodingException {
        ...
        SystemMenuEntity systemMenuEntity = systemMenuService.getMenuByMenuLinkUrl(menuLinkUrl);
    ...
    public ApiResult getSystemMenuByMenuIcon(@PathVariable String menuIcon) throws UnsupportedEncodingException {
        ...
        SystemMenuEntity systemMenuEntity = systemMenuService.getMenuByMenuIcon(menuIcon);
